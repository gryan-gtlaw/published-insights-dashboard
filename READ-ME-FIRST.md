...
- The included sample CSV and bundled Founders Grotesk webfonts will be downloadable by anyone who can access the site.
- Confirm that publishing the sample data and webfonts is permitted under G+T policy and the font licence.
...
1. Rebuild the dashboard locally.
2. In GitHub, open the repository's `docs` folder.
3. Replace the changed files using **Add file → Upload files**.
